...
<section class="command-section principles-panel">
  ...
  <h2>A working board for product development with AI agents.</h2>
  <ul>
...
<section class="command-section">
  ...
  <h2>Buy this if you are already doing real agent-assisted product work.</h2>
  <ul>
    <li>You use GitHub and want agents, issues, pull requests, review gates, and launch tasks in one control surface.</li>
    <li>You are building downloadable products, internal tools, SaaS experiments, or automation workflows and need a board that shows proof.</li>
