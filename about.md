...
I work as a Sr. Services Engineer in Houston, often acting as a solutions architect and automation engineer. I deliver MSP service — migrations, security operations, billing — through agentic-LLM systems I build, with evidence contracts and human approval gates. For about fifteen years I've worked the seam between IT operations and the systems that make them less manual — managed services, Microsoft 365 at enterprise scale, security and identity, and lately the AI-assisted workflow tooling that ties messy service work together.
