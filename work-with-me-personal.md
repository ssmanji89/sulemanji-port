...
description: Optional personal workshop intake for a stuck prototype, home automation, or hobby project.
permalink: /work-with-me/personal
work_with_me_form: true
hero_eyebrow: Personal projects
hero_title: Bring one messy problem.
hero_lede: An optional workshop intake for personal, home-level, and hobby-scale work.
---

For an organizational project or a professional opportunity, [start a conversation here](/work-with-me). This workshop is for personal projects.
